...
extension Data {
    ...
    @inlinable public mutating func appendUInt16(_ value: UInt16) {
        self.append(UInt8((value >> 8) & 0xFF))
        self.append(UInt8(value & 0xFF))
    }
    
    @inlinable public mutating func appendUInt32(_ value: UInt32) {
    ...
    @inlinable public mutating func appendUInt64(_ value: UInt64) {
    ...
    @inlinable public func readUInt16(at offset: inout Int) -> UInt16? {
    ...
    @inlinable public func readUInt32(at offset: inout Int) -> UInt32? {
    ...
    @inlinable public func readUInt64(at offset: inout Int) -> UInt64? {

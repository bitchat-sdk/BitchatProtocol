...
public struct MessagePadding {
    ...
    public static let blockSizes = [256, 512, 1024, 2048]
    
    // Add PKCS#7-style padding to reach target size
    public static func pad(_ data: Data, toSize targetSize: Int) -> Data {
    ...
    public static func optimalBlockSize(for dataSize: Int) -> Int {

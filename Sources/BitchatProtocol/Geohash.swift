...
public enum Geohash {
    ...
    public static func isValidBuildingGeohash(_ geohash: String) -> Bool {
    ...
    public static func decodeCenter(_ geohash: String) -> (lat: Double, lon: Double) {
        var latInterval: (Double, Double) = (-90.0, 90.0)
        var lonInterval: (Double, Double) = (-180.0, 180.0)
    ...
    public static func decodeBounds(_ geohash: String) -> (latMin: Double, latMax: Double, lonMin: Double, lonMax: Double) {
        var latInterval: (Double, Double) = (-90.0, 90.0)
        var lonInterval: (Double, Double) = (-180.0, 180.0)
    ...
    public static func neighbors(of geohash: String) -> [String] {

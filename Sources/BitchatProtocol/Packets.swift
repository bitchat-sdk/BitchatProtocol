...
public struct AnnouncementPacket: Sendable {
    public let nickname: String
    public let noisePublicKey: Data
    public let signingPublicKey: Data
    public let directNeighbors: [Data]?

    public init(nickname: String, noisePublicKey: Data, signingPublicKey: Data, directNeighbors: [Data]? = nil) {
...
public struct PrivateMessagePacket: Sendable {

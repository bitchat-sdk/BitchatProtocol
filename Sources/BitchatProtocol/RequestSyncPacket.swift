...
public struct RequestSyncPacket {
    ...
    public let types: SyncTypeFlags?
    public let sinceTimestamp: UInt64?
    public let fragmentIdFilter: String?

    public init(p: Int, m: UInt32, data: Data, types: SyncTypeFlags? = nil, sinceTimestamp: UInt64? = nil, fragmentIdFilter: String? = nil) {
        self.p = p
        self.m = m
        self.data = data
        self.types = types
    ...
    public static func decode(from data: Data, maxAcceptBytes: Int = 1024) -> RequestSyncPacket? {
        var off = 0
        var p: Int? = nil
        var m: UInt32? = nil

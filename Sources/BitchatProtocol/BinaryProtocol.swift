...
public struct BinaryProtocol {
    ...
    public static let v2HeaderSize = 16
    ...
    public struct Offsets {
        ...
        public static let type = 1
        public static let ttl = 2
        public static let timestamp = 3
    ...
    public struct Flags {
        ...
        public static let isRSR: UInt8 = 0x10
    }

    /// Encode a `BitchatPacket` to wire-format bytes.
    public static func encode(_ packet: BitchatPacket, padding: Bool = true) -> Data? {
    ...
    /// Decode wire-format bytes into a `BitchatPacket`. Returns `nil` for malformed input.

...
public enum GeohashChannelLevel: CaseIterable, Codable, Equatable {
    case building
    case block
    case neighborhood
    case city
...
public struct GeohashChannel: Codable, Equatable, Hashable, Identifiable {
...
public enum ChannelID: Equatable, Codable {
    case mesh
